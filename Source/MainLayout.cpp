...
namespace ui
{
    ...
    {
        this->mainMenu = pu::ui::elm::Menu::New(0, 80, 1280, pu::ui::Color(255,255,255,255), 100, 6);
        this->mainMenu->SetOnFocusColor(pu::ui::Color(102,153,204,255));
        this->mainMenu->SetScrollbarColor(pu::ui::Color(102,153,204,255));
    ...
    void MainLayout::populateMainMenu()
    {
        ...
        pu::ui::elm::MenuItem::Ref item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_AMIIBO));
        ...
        if(emuiibo) {
            ...
            item->SetColor(pu::ui::Color(204,0,0,255));
        }
        this->mainMenu->AddItem(item);

        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_EMUIIBO));
        ...
        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_IMAGES));
        ...
        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_SELECTED_AMIIBO));
        ...
        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_SETTINGS));
        ...
        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_USER_MANUAL));
        item->SetIcon(utils::GetRomFsResource("Common/user-manual.png"));
        item->AddOnClick(std::bind(&MainLayout::manual_Click, this), KEY_A);
        this->mainMenu->AddItem(item);

        item = pu::ui::elm::MenuItem::New(lang::GetLabel(lang::Label::MAIN_ABOUT));
    ...
    {
        pu::ui::extras::Toast::Ref toast = pu::ui::extras::Toast::New("settings", 20, pu::ui::Color(255,255,255,255), pu::ui::Color(0,51,102,255));
	...
	void MainLayout::showSelected_Click()
	{
        ...
        if(rs == 0 && R_FAILED(strcmp(key,amiibo)) && isOk) {
			...
			pu::ui::extras::Toast::Ref toast = pu::ui::extras::Toast::New(lang::GetLabel(lang::Label::HEADER_NO_AMIIBO), 20, pu::ui::Color(255,255,255,255), pu::ui::Color(0,51,102,255));
			mainapp->StartOverlayWithTimeout(toast, 1500);
		}
	}
	...
	{
		pu::ui::extras::Toast::Ref toast = pu::ui::extras::Toast::New(lang::GetLabel(lang::Label::TOAST_EMUIIBO_NOT_INSTALLED), 20, pu::ui::Color(255,255,255,255), pu::ui::Color(204,0,0,255));
		mainapp->StartOverlayWithTimeout(toast, 1500);
	}
