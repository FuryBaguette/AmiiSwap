...
LIBS	:= -lpu -lfreetype -lSDL2_ttf -lSDL2_gfx -lSDL2_image -lwebp -lSDL2_mixer -lmodplug -lmpg123 -lvorbisidec -logg -lSDL2 -lEGL -lGLESv2 -lglapi -ldrm_nouveau -lpng -ljpeg `sdl2-config --libs` `freetype-config --libs` -lnx
